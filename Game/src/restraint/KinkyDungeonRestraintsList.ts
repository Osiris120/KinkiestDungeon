...
const KinkyDungeonRestraints: restraint[] = [
	...
	{renderWhenLinked: ["Corsets", "Harnesses", ...KDBindable, "Latex", "Leather", "Metal", "Rope"], inventory: true,
		name: "LatexCatsuit", inaccessible: true,
	...
	{renderWhenLinked: ["Corsets", "Harnesses", ...KDBindable, "Latex", "Leather", "Metal", "Rope"], inventory: true,
		name: "HeavyLatexCatsuit", inaccessible: true,
		factionColor: [[0]], Asset: "SeamlessCatsuit", AssetGroup: "Suit", Color: ["#3873C3"],
		sfxGroup: "Rubber",
		alwaysAccessible: true,
		Model: "Catsuit",
	...
	{alwaysRender: true, inventory: true, name: "ExpArmbinderHarness", debris: "Belts", accessible: true, Asset: "Corset4", Color: "#383E4D", Group: "ItemTorso", strictness: 0.1, power: 9, weight: -10, OverridePriority: 26,
		...
		escapeChance: {"Struggle": -0.3, "Cut": -0.05, "Remove": 0.08},
	...
	{alwaysRender: true, inventory: true, name: "TrapArmbinderHarness", debris: "Belts", Asset: "LeatherHarness", accessible: true, Color: "Default", Group: "ItemTorso", OverridePriority: 26, LinkableBy: [...KDHarnessLink], power: 3, strictness: 0.1,
		...
		harness: true,
		sfxGroup: "Leather",
		escapeChance: {"Struggle": -0.15, "Cut": 0.15, "Remove": 0.15, "Pick": 0.15},
	...
	{inventory: true, name: "BlacksteelMuzzleGag", LinkableBy: [...KDFlatGagLink], renderWhenLinked: [...KDFlatGagLink], gag: 0.3, Asset: "MuzzleGag", Group: "ItemMouth", AssetGroup: "ItemMouth3", Color: "#999999",
		...
		struggleBreak: true,
		Filters: {
			Metal: {"gamma":0.6166666666666667,"saturation":1,"contrast":1.3,"brightness":2.4166666666666665,"red":1,"green":1,"blue":1,"alpha":1},
			Strap: {"gamma":0.6166666666666667,"saturation":1,"contrast":1.3,"brightness":2.4166666666666665,"red":1,"green":1,"blue":1,"alpha":1},
		},
		factionFilters: {
			Metal: {override: false, color: "DarkNeutral"},
			Rivets: {override: true, color: "LightNeutral"},
		},
	...
	{removePrison: true, divine: true, name: "DivineCuffs", accessible: true, Asset: "FuturisticCuffs",
